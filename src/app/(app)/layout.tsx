...
function MainSidebar() {
  ...
  const navItems = [
    ...
    { href: '/absent-management', label: t.sidebar.absentManagement, icon: UserX, adminOnly: true },
    { href: '/suspended-management', label: t.sidebar.suspendedManagement, icon: Archive, adminOnly: true },
    { href: '/employees', label: t.sidebar.employees, icon: Users, adminOnly: true },
    { href: '/absent-employees', label: t.sidebar.absentEmployees, icon: Archive, adminOnly: true },
    { href: '/suspended-employees', label: t.sidebar.todaySuspendedEmployees, icon: UserMinus, adminOnly: true },
